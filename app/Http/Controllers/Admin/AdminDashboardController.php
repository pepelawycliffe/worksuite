...
class AdminDashboardController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        $this->pendingLeadFollowUps = Lead::selectRaw('leads.*, ( select lead_follow_up.next_follow_up_date from lead_follow_up where lead_follow_up.lead_id = leads.id and DATE(lead_follow_up.next_follow_up_date) < "'.$currentDate.'" ORDER BY lead_follow_up.created_at DESC) as follow_up_date_past,
