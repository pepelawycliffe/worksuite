    ...
    <div class="modal fade bs-modal-md in"  id="subTaskModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md" id="modal-data-application">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <span class="caption-subject font-red-sunglo bold uppercase" id="subTaskModelHeading">Sub Task</span>
                </div>
                <div class="modal-body">
                    Loading...
                </div>
...
<script type="text/javascript">
    ...
    function showTable() {
        ...
        var url = '{!!  route('admin.tasks.data', [':projectId']) !!}?_token={{ csrf_token() }}&status='+status;
...
//                                    swal("Deleted!", response.message, "success");
    ...
    $('#tasks-table').on('click', '.show-task-detail', function () {
        ...
        var id = $(this).data('task-id');
        var url = "{{ route('admin.all-tasks.show',':id') }}?type=project";
        url = url.replace(':id', id);
    ...
    $('#dependent-task').change(function () {
        if($(this).is(':checked')){
            ...
            $('#dependent_task_id').val('');
            $('#dependent_task_id').trigger('change');
        }
    })
