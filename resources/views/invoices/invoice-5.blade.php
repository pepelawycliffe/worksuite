                        ...
                        @foreach ($invoice->items as $item)
                            @if ($item->type == 'item')
                                ...
                                <tr class="main-table-items text-black">
                                    ...
                                    <td align="right">{{ currency_formatter( $item->amount,$global->currency->currency_symbol) }}</td>
                                </tr>
                                <!-- Table Row End -->
                            ...
                            <td colspan="2" class="total-box">
                                <table width="100%" class="b-collapse">
                                    ...
                                    <tr align="right" class="text-grey">
                                        ...
                                        <td class="total-amt f-15">{{currency_formatter($invoice->total,'') }}</td>
                                    </tr>
                                    <!-- Table Row End -->
                                    <!-- Table Row Start -->
                                    <tr align="right" class="balance text-black">
                                        ...
                                        <td class="balance-right">{{ currency_formatter($invoice->amountDue(),'') }}
        ...
        <table class="f-14 b-collapse" width="100%">
            ...
            @forelse($payments as $key => $payment)
                <tr class="main-table-items">
                    ...
                    <td class="text-center">{{  currency_formatter($payment->amount,'') }} {{ $invoice->currency->currency_code }}</td>
